<!DOCTYPE html><html class="backend"><!-- START Head --><head>
    <!-- START META SECTION -->
    <meta charset="utf-8">
...
<script type="text/javascript" src="bootstrap-noconflict.js"></script>
...
<div class="container animation delay animating fadeInDown">
    <!-- START row -->
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <div class="panel panel-minimal" style="margin-top:10%;">
                ...
                <div class="panel-body text-center">
                    <h1 class="semibold longshadow text-center text-default fsize32 mb10 mt0">SOMETHING WENT WRONG!!</h1>
                    <h4 class="semibold text-primary text-center nm"></h4>
                </div>
                <!--/ Upper Text -->
                <!-- Button -->
                <div class="panel-body text-center">
                                            <a href="../index.html" class="btn btn-default mb5">Take Me Back</a>
                                    </div>
                <!--/ Button -->
            </div>
        </div>
...
<!--/ END Template Container -->    </section>
    <!--/ END Template Main -->
